...
public class First extends JFrame {
	...
	public First() {
		...
		btnSupprimerContact.setBackground(new Color(176, 224, 230));
		...
		btnModifierContact.setBackground(new Color(176, 224, 230));
		...
		btnSupprimerContact.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(ind>=0)
				{
					int option = JOptionPane.showConfirmDialog(First.this, "Sur de supprimer ce contact ?");
					if(option == 0)//YES
					{
